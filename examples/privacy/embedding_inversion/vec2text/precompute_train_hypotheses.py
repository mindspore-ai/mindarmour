...
def precompute(start_idx: int, num_samples: int):
    ...
    out_path = (f"/home/jxm3/research/retrieval/inversion/msmarco_msl128_hypotheses/"
                f"msmarco_{num_samples}_{start_idx}.arrow")
    if os.path.exists(out_path):
        print("already precomputed; exiting")
    # load the previously-trained msmarco model
    _, trainer = aliases.load_experiment_and_trainer_from_alias(
